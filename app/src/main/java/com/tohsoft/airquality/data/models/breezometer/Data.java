...
public class Data {
    ...
    private HashMap<String, String> health_recommendations;
    ...
    public HashMap<String, String> getHealth_recommendations() {
        return health_recommendations;
    }

    public void setHealth_recommendations(HashMap<String, String> health_recommendations) {
